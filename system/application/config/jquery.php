nda<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
...
$config['jquery']['main_library_path']		= "jquery-1.4.4.min.js";// without the first slash if is a local path.
$config['jquery']['libraries_prefix']		= "js/jquery/";
